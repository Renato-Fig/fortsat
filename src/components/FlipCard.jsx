  ...
  return (
    <a className="group [perspective:1000px] w-full aspect-square" href={href}>
      <div className="relative  w-full h-full transition-transform duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        <div className={`absolute inset-0 ${frontBg} overflow-hidden rounded-3xl p-6 flex flex-col justify-between [backface-visibility:hidden]`}>
        ...
        <div className={`absolute inset-0 ${backBg} rounded-3xl p-6 flex flex-col justify-center items-center [transform:rotateY(180deg)] [backface-visibility:hidden]`}>
          <img src={logo} alt="" />
