export function Hero() {
    return (
        <section className="w-full h-screen mx-auto p-0 sm:p-6 ">
            <div className=" w-full h-full mx-auto flex flex-col align-center items-center sm:rounded-xl overflow-hidden justify-between bg-[url('/images/bg.jpg')] p-8 bg-no-repeat bg-cover bg-center">
                <p className="">
                    Menu
                </p>
                <div className="text-center flex flex-col max-w-4xl">
                    ...
                    <p className="text-base sm:text-lg text-[#FFF] max-w-3xl">
